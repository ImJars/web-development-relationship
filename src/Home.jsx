        ...
        <div>
          ...
          >
            <path
              ...
              strokeMiterlimit="10"
              d="M596.278 1382.9c-5.727-5.73-566.402-192.47-410.206-588.85C342.268 397.447 223.083 218.635-112 1.285"
              className="animate-lineLeft1"
            ></path>
          </svg>
          {/* svg */}
          <svg
          ...
          >
            <path
              ...
              strokeMiterlimit="10"
              d="M136.119-284s148.265 338.467-65.21 763.918c-213.475 425.451 90.545 739.692 499.43 742.112"
              className="animate-lineLeft2"
            ></path>
          </svg>
          {/* svg */}
          <svg
          ...
          >
            <path
              ...
              strokeMiterlimit="10"
              d="M133.036-181.161s151.789 224.177 16.963 485.789C15.173 566.241-185.304 857.362 365.236 1120.08"
              className="animate-lineLeft3"
            ></path>
          </svg>
          <svg
            fill="none"
            viewBox="0 0 279 1024"
            xmlns="http://www.w3.org/2000/svg"
            role="img"
          ...
          >
            <path
              ...
              strokeMiterlimit="10"
              d="M278.357 1072.94c-2.491-5.86-444.34-286.628-207.667-536.474C307.363 286.621 271.95 116.741 86.17-146.788"
              className="animate-lineRight1"
            ></path>
          </svg>
          {/* svg */}
          <svg
          ...
          >
            <path
              ...
              strokeMiterlimit="10"
              d="M439.882-169s9.075 298.002-279.203 552.29c-288.279 254.287-154.995 581.076 150.545 706"
              className="animate-lineRight2"
            ></path>
          </svg>
          {/* svg */}
          <svg
            fill="none"
            viewBox="0 0 205 1024"
            xmlns="http://www.w3.org/2000/svg"
            role="img"
          ...
          >
            <path
              ...
              strokeMiterlimit="10"
              d="M386.994-19.021s46.267 213.594-133.818 368.903C73.091 505.192-164.828 662.633 168.65 1025.14"
              className="animate-lineRight3"
            ></path>
          </svg>
        </div>
      </section>
